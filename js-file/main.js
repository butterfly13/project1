...
function wrongClick () {
  ...
  var gameOver = document.querySelector('span.winner')
...
function checkWinner () {
  numOfRightClick++
  console.log(`number of right click: ${numOfRightClick}`)
  var winner = document.querySelector('span.winner')
  if (content.length === numOfRightClick) {
	  console.log('You are rock!!')
	  winner.style.display = 'block'
	  winner.textContent = ' You ARE ROCK'
	  document.querySelector('.restartButton').style.display = 'block'
  }
}
